...
@Service
public class Export1QueryExecutorServiceImpl implements Export1QueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Export1QueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("Export1WMQueryExecutor")
