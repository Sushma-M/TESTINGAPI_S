...
import com.testingapi_s.export1.service.Export1QueryExecutorService;
...
@RestController(value = "Export1.QueryExecutionController")
@Api(value = "QueryExecutionController", description = "Controller class for query execution")
@RequestMapping("/Export1/queryExecutor")
public class QueryExecutionController {

    private static final Logger LOGGER = LoggerFactory.getLogger(QueryExecutionController.class);

    @Autowired
    private Export1QueryExecutorService queryService;
