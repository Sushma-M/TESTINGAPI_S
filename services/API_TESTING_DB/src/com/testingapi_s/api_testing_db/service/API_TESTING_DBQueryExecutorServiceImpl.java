...
@Service
public class API_TESTING_DBQueryExecutorServiceImpl implements API_TESTING_DBQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(API_TESTING_DBQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("API_TESTING_DBWMQueryExecutor")
