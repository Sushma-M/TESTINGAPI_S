...
import com.testingapi_s.api_testing_db.service.API_TESTING_DBQueryExecutorService;
...
@RestController(value = "API_TESTING_DB.QueryExecutionController")
@Api(value = "QueryExecutionController", description = "Controller class for query execution")
@RequestMapping("/API_TESTING_DB/queryExecutor")
public class QueryExecutionController {

    private static final Logger LOGGER = LoggerFactory.getLogger(QueryExecutionController.class);

    @Autowired
    private API_TESTING_DBQueryExecutorService queryService;
