...
import com.testingapi_s.api_testing_db.service.ProductDetailsService;

/**
 * Controller object for domain model class ProductDetails.
 * @see ProductDetails
 */
@RestController("API_TESTING_DB.ProductDetailsController")
@Api(value = "ProductDetailsController", description = "Exposes APIs to work with ProductDetails resource.")
@RequestMapping("/API_TESTING_DB/ProductDetails")
public class ProductDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ProductDetails getProductDetails(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ProductDetails editProductDetails(@PathVariable("id") Integer id, @RequestBody ProductDetails productDetails) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteProductDetails(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<ProductDetails> findProductDetails(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering ProductDetails list");
    ...
    @ApiOperation(value = "Returns the total count of ProductDetails instances.")
